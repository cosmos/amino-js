...
const txData = '';
...
const accountData           = 'Yvt4DwqcAQpUChTVRec4TD1vW7p6GyUrThqVbrrGTBIPCgV1YXRvbRIGMTc5ODQ4GibrWumHIQKYe02D/64eNwOGvV8fs+7Nr4O3wn9SS6I9ZgPcmQ1jEiCbASg7EhQKBXVhdG9tEgsxMTAwMDAwMDAwMBoSCgV1YXRvbRIJMjA5Nzk3NjA3IhQKBXVhdG9tEgsxMTAwMDAwMDAwMCjwoLDzBQ==';
...
describe('Store', () => {
    describe('decoding', () => {
        ...
        describe('IAVLValueOp', () => {
            it('decodes bytes', () => {
                const bytes = base64ToBytes(iavlValueOpData);
        ...
        describe('MultiStoreProofOp', () => {
            it('decodes bytes', () => {
                const bytes = base64ToBytes(multiStoreProofOpData);
