...
build: clean
	...
	gopherjs build -v -o ./dist/main.js ./go/main/main.go
...
min: clean
	cp ./static/index.html ./dist/
	gopherjs build -v -m -o ./dist/main.min.js ./go/main/main.go
...
watch: clean
	cp ./static/index.html ./dist/
	gopherjs build -w -v -o ./dist/main.js ./go/main/main.go

# main: clean wasm_exec
# 	cp ./wasm/index.html ./dist/
# 	cp ./wasm/main.js ./dist/
# 	GOOS=js GOARCH=wasm go build -o ./dist/main.wasm ./go/main/main.go
#
# wasm_exec:
